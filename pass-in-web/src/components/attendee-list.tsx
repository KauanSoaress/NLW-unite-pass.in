  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex gap-3 items-center">
        ...
        <div className="px-3 py-[6px] w-[280px] border border-white/10 rounded-lg flex items-center gap-3">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/10">
              <th style={{ width: 48 }} className="py-3 px-4 text-sm font-semibold text-left"> {/* Chave dentro de chave por estar usando uma variável JS (chave mais externa) e por estar incluindo um objeto JS dentro dela (chave mais interna) */}
                ...
                <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                  ...
                  <td className="py-3 px-4 text-sm text-zinc-300">
                    <div className="flex flex-col gap-1">
                      <span className="font-semibold text-white">Kauan Guilherme de Brito Soares</span>
                      <span>gbskauan@gmail.com</span>
                    </div>
                  </td>
                  <td className="py-3 px-4 text-sm text-zinc-300">7 dias atrás</td>
                  <td className="py-3 px-4 text-sm text-zinc-300">3 dias atrás</td>
                  <td className="py-3 px-4 text-sm text-zinc-300">
                    <button className="bg-black/20 border border-white/10 rounded-md p-[6px]">
              ...
              <td colSpan={3} className="py-3 px-4 text-sm font-semibold text-right">
                <div className="inline-flex gap-8">
                  ...
                  <div className="flex gap-[6px]">
                    <button className="bg-white/10 border border-white/10 rounded-md p-[6px]">
